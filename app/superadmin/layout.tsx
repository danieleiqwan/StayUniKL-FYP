...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
    ...
    if (isCheckingAuth) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-white dark:bg-zinc-950 transition-colors">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-[10px] font-black text-zinc-400 dark:text-zinc-600 uppercase tracking-[0.3em] animate-pulse">
                        Verifying Authority...
                    </p>
                </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white flex">
            ...
            <main className="flex-1 min-h-screen flex flex-col">
                ...
                <footer className="px-10 py-6 text-center text-[9px] font-black text-zinc-400 dark:text-zinc-700 uppercase tracking-[0.3em]">
