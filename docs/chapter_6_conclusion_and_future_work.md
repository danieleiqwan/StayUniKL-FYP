...
3. **UniKL SIS API Integration:** Establish a direct API pipeline with UniKL’s central database to automatically pull student enrollment details, academic standings, and disciplinary records.
